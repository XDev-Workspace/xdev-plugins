...
//   caveman : <agentDir>/caveman.json            { defaultLevel, showStatus }
//   ponytail: $XDG_CONFIG_HOME|~/.config/ponytail/config.json { defaultMode }
//   rtk     : <agentDir>/extensions/pi-rtk-optimizer/config.json { enabled }
...
export function setCavemanDefault(level) {
  ...
  const path = join(agentDir(), "caveman.json");
